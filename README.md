...
| **[ssuAI](https://github.com/hoeongj/ssuAI)** | 웹 클라이언트 — 대시보드 + 자연어 챗봇 | Next.js 16 · TypeScript · TanStack Query · Tailwind/shadcn · Vitest |
| **[ssuAgent](https://github.com/hoeongj/ssuAgent)** | LangGraph 멀티에이전트 — SSE 스트리밍 · HITL | Python · LangGraph · FastAPI · 멀티프로바이더 LLM 폴백 |
| **[ssu-ai-service](https://github.com/hoeongj/ssu-ai-service)** | B2B 임베딩 게이트웨이 — 인증·키 위생 설계 | Python · FastAPI |
