...
- **Debugging log** → [Troubleshooting highlights](https://github.com/ghdtjdwn/ssuMCP/blob/main/docs/troubleshooting-highlights.md): 8 major cases, each written up as *wrong hypothesis → actual cause → fix*.
